...
class Pin:
    ...
    def draw(self,screen):
        ...
        if self.colour is not None and self.revealed:  
            pygame.draw.circle(screen, tuple(x * 0.3 for x in self.colour), tuple(x + 2 for x in center), 15 )
            pygame.draw.circle(screen, self.colour, center, 15)
        elif not self.revealed:
            pygame.draw.circle(screen, LIGHTGREY, center, 15)
            pygame.draw.circle(screen, DARKBROWN, center, 15, 3)
...
class Board:
    def __init__(self):
        ...
        self.colour_selection_surface.fill(BGCOLOUR)
    ...
    def draw(self, screen):
        ...
        #Drawing placeholders for colour pins
